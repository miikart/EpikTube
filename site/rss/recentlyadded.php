...
if($_SERVER['REQUEST_URI'] == "/rss/global/recently_added.rss" || $_SERVER['REQUEST_URI'] == "/rss/") {
	...
	if($user->rowCount() > 0) {
		...
		$feed_link = "http://www.epiktube.xyz/rss/user/".htmlspecialchars($user['username'])."/my_videos.rss";
...
<rss version="2.0" xmlns:media="http://search.yahoo.com/mrss">
	<channel>
		<title>EpikTube: <?php echo $feed_title; ?></title>
		...
		<item>
			...
			<description><![CDATA[
				<img src="http://www.epiktube.xyz/get_still.php?video_id=<?php echo htmlspecialchars($video['vid']); ?>" align="right" border="0" width="120" height="90" vspace="4" hspace="4" />
				<p><?php echo htmlspecialchars($video['description']); ?></p>
				<p>
					Author: <a href="http://www.epiktube.xyz/profile.php?user=<?php echo htmlspecialchars($video['username']); ?>"><?php echo htmlspecialchars($video['username']); ?></a><br/>
					Keywords: <?php foreach(explode(" ", $video['tags']) as $tag) echo '<a href="http://www.epiktube.xyz/results.php?search='.htmlspecialchars($tag).'">'.htmlspecialchars($tag).'</a> '; ?><br/>
			...
			<media:thumbnail url="http://www.epiktube.xyz/get_still.php?video_id=<?php echo htmlspecialchars($video['vid']); ?>" width="120" height="90" />
