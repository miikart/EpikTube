						...
						<tbody><tr valign="top">
							...
							<table cellpadding="0" cellspacing="0" border="0">
								<tbody><tr>
									...
									<td><a href="watch?v=<?php echo $video['vid']; ?>&search=<? echo htmlspecialchars($profile['username']); ?>"><img src="<?php if($current_page != "profile_friends") { ?>/get_still?video_id=<?php echo $video['vid']; ?><?php } else { ?><?php echo getlatestvideo($video['uid']) ?><?php } ?>" class="moduleEntryThumb"  width="120" height="90"></a></td>
				...
				<table width="565" cellpadding="0" cellspacing="0" border="0">
					<tr valign="top">
						<td align="center">
							...
							<a href="profile?user=<?= htmlspecialchars($video['username']) ?>"><img src="<?php echo getlatestvideo($video['uid']); ?>" class="moduleEntryThumb" width="90" height="70"></a>
