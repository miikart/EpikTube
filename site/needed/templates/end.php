...
<div id="footerDiv">
	...
	<div id="copyrightDiv">
	made with love by copy.floppy 2024 <3 | <span id="footerRSSspan">PHP: <?php echo $php ?> | DB: mysqlnd <?php echo $thethingylolol;?> | <a href="/rssls"><img src="/img/rss.gif" style="vertical-align: text-top;" width="36" height="14" border="0"></a></span>
	</div>
</div>
